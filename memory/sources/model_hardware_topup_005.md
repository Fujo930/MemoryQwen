# Model Hardware Top-up 005：GPU Guardian game_mode 下避免 deep mode
...
game_mode 检测到游戏/创作进程时，推荐 pause_background_tasks 和 prefer_7b。14B deep mode 占用额外 ~8GB VRAM，会严重影响游戏帧率和显存可用性。
...
v0.1, megatrain, m1, model_hardware, topup, doc005
