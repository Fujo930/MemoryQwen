# Model Hardware Top-up 002：7B 常驻 + 14B deep mode 协作
...
7B 处理日常聊天和普通检索（低延迟低显存）。14B 处理复杂推理和长文档（GPU 空闲时）。两者分工协作，互不替代。GPU Guardian 根据负载自动推荐切换。
...
v0.1, megatrain, m1, model_hardware, topup, doc002
