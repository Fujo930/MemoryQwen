# Model Hardware Top-up 010：model profile 和 eval 如何影响推荐
...
7B retest：91% 边界准确率。3B：64%。capability_boundary_guard 在 3B 上触发频率更高但效果更差。evals 结果直接支持 7B 作为默认推荐。
...
v0.1, megatrain, m1, model_hardware, topup, doc010
