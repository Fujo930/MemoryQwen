# Model Hardware Top-up 008：24GB VRAM 下 14B/32B 实验边界
...
14B Q4: ~9GB。32B Q4: ~19GB。24GB 可实验 32B 但 context 窗口受限、KV cache 受压。不推荐作为默认家用配置。
...
v0.1, megatrain, m1, model_hardware, topup, doc008
