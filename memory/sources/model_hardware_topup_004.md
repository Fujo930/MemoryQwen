# Model Hardware Top-up 004：RTX 3080+ 不应长期常驻 14B
...
不推荐 14B 替代 7B 常驻。7B 延迟更低、显存更友好。14B 作为 deep mode 按需使用。GPU Guardian 在游戏时自动建议切回 7B。
...
v0.1, megatrain, m1, model_hardware, topup, doc004
