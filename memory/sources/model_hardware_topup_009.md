# Model Hardware Top-up 009：3B 只能 smoke test 不能当正式主力
...
3B capability boundary ~64%。PDF/WebUI/daemon/embedding 等边界问题频繁出错。只能验证系统链路，不能用于正式问答或能力边界判断。
...
v0.1, megatrain, m1, model_hardware, topup, doc009
