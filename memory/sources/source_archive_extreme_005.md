# Source Archive Extreme 文档 005：第5条正确语义
...
本文档第 5 次强调：理解 inbox、memory/sources、memoryqwen.db、tasks.db 的正确语义是使用和备份 MemoryQwen 的基础。混淆这些概念会导致数据丢失。
...
v0.1, megatrain, m1, source_archive, doc005
